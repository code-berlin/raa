...
;(function($) {
  ...
  function inViewport(element, viewportRect) {
    ...
    var appearTopOffset = $(element).data('appearTopOffset') ? $(element).data('appearTopOffset') : 0; // hacked to add an offset
    ...
    for(var i = 0; i < corners.length; i++) {
      ...
      if (corner.y <= viewportRect.bottom + appearTopOffset &&
          corner.y >= viewportRect.top - appearTopOffset &&
    ...
    if (elementRect.top <= viewportRect.top - appearTopOffset && elementRect.bottom >= viewportRect.bottom + appearTopOffset) {
      return true;
    }
