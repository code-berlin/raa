    ...
    */
    public function page()
    {
        ...
        if ($auth->check_section_access_required_permissions($role_id, $url)) {
            ...
            $crud->edit_fields('template_id', 'parent_id', 'main_category', 'commercial', 'headline', 'introtext', 'menu_title', 'menu_title_mobile', 'teaser_title', 'teaser_text', 'text', 'date', 'date_created', 'image', 'image_alt', 'slug', 'published', 'id', 'seo_meta_keywords', 'seo_meta_title', 'seo_meta_description', 'seo_footer_text', 'sitemap_prio', 'use_copyright_text', 'copyright_text', 'ad_keywords', 'additional_text', 'author_id', 'productteaser_order');
    ...
    */
    public function sidebar_teaser()
    {
        ...
        if ($auth->check_section_access_required_permissions($role_id, $url)) {
            ...
            // Fields to show on the list
            $crud->columns('sidebarteasertypes_id', 'position', 'title', 'text', 'image', 'html', 'url', 'published', 'external', 'alternative', 'commercial');

            $crud->order_by('position','asc');

            $crud->add_fields('sidebarteasertypes_id', 'position', 'title', 'text', 'image', 'html', 'url', 'published', 'external', 'alternative', 'commercial');
            $crud->edit_fields('sidebarteasertypes_id', 'position', 'title', 'text', 'image', 'html', 'url', 'published', 'external', 'alternative', 'commercial');
